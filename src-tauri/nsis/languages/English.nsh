...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R0 version of ${PRODUCTNAME} is installed on your system. It is recommended to uninstall the current version before installing. Select your operation:"
